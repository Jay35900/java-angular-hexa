...
private PolicyHolderRepository policyHolderRepository;
	...
	public PolicyHolder validate(int id) throws ResourceNotFoundException {
		...
		if(optional.isEmpty())
			throw new ResourceNotFoundException("please enter a valid holder id");
		
		PolicyHolder policyHolder = optional.get();
		return policyHolder; 
		
	}
	public List<PolicyHolder> insertAll(List<PolicyHolder> holders) {
	
		return policyHolderRepository.saveAll(holders);
	}
